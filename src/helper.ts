...
export async function getPaperByFilter(semester: string, department: string, subjectName: string, examType: string) {
...
export async function upload(cloudUrl:string[], semester: string, department: string, subjectName: string, examType: string,comments:string) {
